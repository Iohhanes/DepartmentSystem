...
import {selectAllData, selectStudentsByGroup} from "../../utils/select-all-data.utils";
...
const GroupEditContainer: FC = () => {
    ...
    return (
        <Spin indicator={<LoadingOutlined style={{fontSize: 24}} spin/>} spinning={loading}>
            {!loading &&
            <GroupFormComponent onSubmit={handleSubmit} current={currentGroup} specialities={specialities}
                                students={students}/>}
        </Spin>
    )
}
